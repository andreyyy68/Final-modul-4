...
class CustomRequester:
    ...
    def send_request(self, method, endpoint, data=None, params=None, headers=None, expected_status=200, need_logging=True, timeout=(5,30)):
        """
        ...
        response = self.session.request(method, url, json=data, params=params, headers=final_headers, timeout=timeout)
        if need_logging:
